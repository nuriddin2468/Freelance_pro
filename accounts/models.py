...
class EmployerModel(models.Model):
    ...
    banner = models.ImageField(upload_to="company/banner/", verbose_name='banner(1110x300)')
    bannerMini = models.ImageField(upload_to='company/banner/mini/', default='', verbose_name='banner(350x172)')
    logo = models.ImageField(upload_to="company/logo/", verbose_name='logo(100x100)')
